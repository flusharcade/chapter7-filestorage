...
namespace FileStorage.Controls
{
	...
	public class CarouselView : Layout<View>
	{
		...
		public INotifyCollectionChanged ItemChangesSource
		{
			get
			{
				return (INotifyCollectionChanged)this.GetValue(CarouselView.ItemsSourceProperty);
			}
			set
			{
				this.SetValue(CarouselView.ItemsSourceProperty, (object)value);
			}
		}
		...
		public static readonly BindableProperty ItemsSourceProperty =
			BindableProperty.Create(
				...
				propertyChanged: (bindableObject, oldValue, newValue) =>
				{
					...
					((CarouselView)bindableObject).ItemChangesSource.CollectionChanged -= ((CarouselView)bindableObject).HandleCollectionChanged;
					((CarouselView)bindableObject).ItemChangesSource.CollectionChanged += ((CarouselView)bindableObject).HandleCollectionChanged;
